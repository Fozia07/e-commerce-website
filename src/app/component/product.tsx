    ...
    <div>
       <div max-w-screen-2xl mx-auto >
            <div className=''>
             ...
             <p className='text-slate-600 pl-10 mb-10 text-3xl  lg:text-4xl text-center '>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Esse dolorem vel vero, culpa eveniet soluta ad unde laudantium ducimus dolore quisquam ullam earum nam voluptate. Est placeat quaerat voluptatem unde!
         ...
         <div className='columns-1 md:columns-2 lg:columns-3 px-10   lg:ml-30'> 
              <div className=' '>
                <Image src={image1} alt='marbles' className='w-full'></Image>
                <div className='bg-gray-950 '>
                  <h1 className='text-white text-center  text-lg font-medium'>Bathroom Tiles</h1>
                 <Link href=''>
                 <p className='text-white text-center text-sm '>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta commodi in magni dignissimos autem pariatur,</p>
                 </Link>
               </div>
